...
yarn snarkjs powersoftau new bn128 15 zk/pot15_0000.ptau -v
...
yarn snarkjs powersoftau contribute zk/pot15_0000.ptau zk/pot15_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/pot15_0001.ptau zk/pot15_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/pot15_0002.ptau zk/pot15_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
yarn snarkjs powersoftau verify zk/pot15_0003.ptau
...
yarn snarkjs powersoftau beacon zk/pot15_0003.ptau zk/pot15_beacon.ptau \
...
yarn snarkjs powersoftau prepare phase2 zk/pot15_beacon.ptau zk/pot15_final.ptau -v

# Verify the final ptau file. Creates the file pot15_final.ptau
yarn snarkjs powersoftau verify zk/pot15_final.ptau