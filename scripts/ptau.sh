...
yarn snarkjs powersoftau new bn128 15 build/pot15_0000.ptau -v
...
yarn snarkjs powersoftau contribute build/pot15_0000.ptau build/pot15_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute build/pot15_0001.ptau build/pot15_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute build/pot15_0002.ptau build/pot15_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
yarn snarkjs powersoftau verify build/pot15_0003.ptau
...
yarn snarkjs powersoftau beacon build/pot15_0003.ptau build/pot15_beacon.ptau \
...
yarn snarkjs powersoftau prepare phase2 build/pot15_beacon.ptau build/pot15_final.ptau -v

# Verify the final ptau file. Creates the file pot15_final.ptau
yarn snarkjs powersoftau verify build/pot15_final.ptau